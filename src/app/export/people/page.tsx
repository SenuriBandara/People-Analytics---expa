...
export default function ExportPeople() {
    ...
    async function getData() {
        ...
        const formedUrl = `/api/export/people-analytics?${urlParams}`;
    ...
    async function copyToClipBoard() {
        if (!blob) return;
        await navigator.clipboard.writeText((await blob.text()).replaceAll(",", "\t"));
        notifications.show({
            title: "Copied to clipboard",
            message: (
                <div>
                    You can now paste in a Google Sheet. Click{" "}
                    <a className={"text-aiesec-blue underline"} href={"https://sheets.new"} target={"_blank"}>
                        here
                    </a>{" "}
                            ...
                            <div className={`flex flex-row space-x-5`}>
                                ...
                                >
                                    <div className={`flex flex-col items-center justify-center`}>
                                        ...
                                        <div className={`text-xs opacity-75 font-light`}>for working with Excel</div>
                                    </div>
                                </a>
                                <a
